...
export default props => (
    ...
    title={{color:'#fff'}}>
        <Scene key="root" >
            ...
            <Scene key="principal" hideNavBar={true}  component={Principal}  initial title="Principal" />
            <Scene key="adicionarContatos" hideNavBar={false}  component={AdicionarContatos}   title="adicionar Contatos" />
        </Scene>
    </Router>
); 